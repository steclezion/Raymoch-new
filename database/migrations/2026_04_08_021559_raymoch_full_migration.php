...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('organization_operating_countries', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['organization_id', 'country_id', 'market_role'], 'org_country_market_role_unique');
        });
        ...
        Schema::create('saved_matches', function (Blueprint $table) {
            ...
            $table->foreignId('match_id')->constrained('matches')->cascadeOnDelete();
            $table->timestamps();
            $table->unique(['organization_id', 'match_id']);
        });

        Schema::create('favorite_organizations', function (Blueprint $table) {
            $table->id();
            $table->foreignId('organization_id')->constrained('organizations')->cascadeOnDelete();
            $table->foreignId('favorite_organization_id')->constrained('organizations')->cascadeOnDelete();
            $table->timestamps();
            $table->unique(
                ['organization_id', 'favorite_organization_id'],
                'org_fav_unique'
            );
        });
        ...
        Schema::create('organization_reviews', function (Blueprint $table) {
            ...
            $table->foreignId('reviewed_organization_id')->constrained('organizations')->cascadeOnDelete();
        ...
        Schema::create('transaction_histories', function (Blueprint $table) {
            $table->id();
            $table->foreignId('organization_id')->constrained('organizations')->cascadeOnDelete();
            $table->foreignId('counterparty_organization_id')->constrained('organizations')->cascadeOnDelete();
        ...
        Schema::create('recommendation_logs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('organization_id')->constrained('organizations')->cascadeOnDelete();
            $table->foreignId('recommended_organization_id')->constrained('organizations')->cascadeOnDelete();
