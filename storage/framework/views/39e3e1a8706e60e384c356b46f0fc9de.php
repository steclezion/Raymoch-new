...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"/>
  ...
  <?php echo app('Illuminate\Foundation\Vite')('resources/js/verify.jsx'); ?>
...
<?php $__env->stopSection(); ?>
  ...
  <script>
    window.APP = {
      ...
      apiVerify: "<?php echo e(route('api.trial-requests.verify')); ?>",
      // optional: server-side pass-through (your VerifyCode also reads from URL)
      // email: "<?php echo e(request('email')); ?>"
    };
  </script>


<?php echo $__env->make('layouts.app_raymoch_new', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\stecl\OneDrive\Documents\Raymoch\resources\views/pages/auth/trial-verify.blade.php ENDPATH**/ ?>