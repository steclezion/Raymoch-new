    ...
    <div class="container">
      ...
      <section class="svc-menu" aria-labelledby="svcMenuTitle">
        ...
        <div class="svc-grid" id="svcGrid">
          <a class="svc-box svc-col-3" href="{{ route('matching') }}" id="boxMatching">
            <h3>Matching</h3>
            <p>Investor inputs → ranked SME matches.</p>
          </a>
          <a class="svc-box svc-col-3" href="{{ route('partner-programs') }}" id="boxPartners">
            <h3>Partner Programs</h3>
            <p>Accelerators & syndicates, plugged in.</p>
          </a>
          <a class="svc-box svc-col-3"  href="{{ route('verification') }}" id="boxVerify">
            <h3>Verification</h3>
            <p>CTI checks: identity, ownership, basics.</p>
          </a>
          <a class="svc-box svc-col-3"    href="{{ route('visibility-listing') }}" id="boxListing">
