...
@include('layouts.style_entire')
  ...
  {{-- Paste the page-specific content from Entire.html hero/sections here --}}
  {{-- <section class="hero" aria-label= " RAYMOCH: Redefining African Potential">
    <div class="hero-inner">
      <h1>Connecting Africa</h1>
      <p>By connect investors and entrepreneurs through trust, verified data,
         and actionable insights. Our mission is to unlock visibility and capital for businesses across Africa and beyond.</p>
    </div>
  </section> --}}
