...
// document.getElementById('manufacturer_api_activity').value=data.activity;
...
//document.getElementById('manufacturer_api_country').selected=true;
...
function Delete_composition(id)
      ...
      Toastr();
      toastr.error("Product composition  removed successfully from your application.")
                         } 
...
toastr.success("Application Number Generated Successfully "+ data.application_number)
  ...
  var id = setInterval(confirm, 1000);
     ...
     {
Toastr();
toastr.error("Directory with the same name exits");
...
$('#manufacturer_city').css("background-color", "#ffffff");
...
for(var j = 0; j < cellLength; j++)
{
 ...
 {
    Toastr();
    var alert ='Name (INN) product compostion for the medical product <b style="color:blue"> '+name_inn_text_composition+' </b>  is duplicated.'
...
var manufacturer_api_tele =  manufacturer_api_tele;
...
// toastr.success("New application has been initiated.")
...
$('#dossier_sample_save').click(function () {
                 ...
                 if(document.getElementById('LINK').checked == true)
                 {
                   ...
                   var flag_dossier_url = document.getElementById('flag_dossier_url').value;
                  ...
                  { 
                    ...
                    var flag_dossier_url = document.getElementById('flag_dossier_url_express').value;
                  ...
                  $.ajax({
                       data:{ 
                            ...
                            flag_dossier_url:flag_dossier_url ,
