              ...
              <div class="card card-body">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Search by Name of Company">
                     ...
                     <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Search by Co-Founder Name">
                                ...
                                <div class="col-lg-6">
                                    <div class="row g-4">
                                        <div class="col-sm-6">
                                            <div class="row g-4">
                                                <div class="col-lg-12">
                                                    <img src="images/misc/3.webp" class="w-100 rounded-1 wow zoomIn" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="row g-4">
                                                <div class="col-lg-12">
                                                    <img src="images/misc/1.webp" class="w-100 rounded-1 wow zoomIn" alt="">
                                                </div>
                                                <div class="col-lg-12">
                                                    <img src="images/misc/2.webp" class="w-100 rounded-1 wow zoomIn" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="col-lg-6">
                                    <div class="hover rounded-1 overflow-hidden relative text-light wow fadeInRight" data-wow-delay=".3s">
                                        ...
                                        <div class="abs z-2 bottom-0 w-100 hover-op-0">
                                            <div class="bg-blur d-flex m-4 p-3 px-4 rounded-1">
                                                <div class="me-5">
                                                    Name
                                                    <h5>Garden Beauty</h5>
                                                </div>
