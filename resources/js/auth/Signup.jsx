  ...
  return (
    <div className="card" role="form" aria-label="Sign up">
      ...
      <div className="pass-wrap">
        <input id="password" className="input" type={show?"text":"password"} placeholder="Create a password"
      ...
      <input id="confirm" className="input" type={show?"text":"password"} placeholder="Re-enter password"
